set moduleName maxPool_4_10_5_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {maxPool<4, 10, 5>}
set C_modelType { void 0 }
set C_modelArgList {
	{ ifmap_0 float 32 regular {array 200 { 1 1 } 1 1 }  }
	{ ifmap_1 float 32 regular {array 200 { 1 1 } 1 1 }  }
	{ ofmap float 32 regular {array 100 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ ofmap_address0 sc_out sc_lv 7 signal 2 } 
	{ ofmap_ce0 sc_out sc_logic 1 signal 2 } 
	{ ofmap_we0 sc_out sc_logic 1 signal 2 } 
	{ ofmap_d0 sc_out sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ofmap_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "ofmap", "role": "address0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "ifmap_0", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0"},
			{"Name" : "ifmap_1", "Type" : "Memory", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0"},
			{"Name" : "ofmap", "Type" : "Memory", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0"}],
		"Loop" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U387", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U388", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U389", "Parent" : "0"},
...
set Spec2ImplPortList { 
	ifmap_0 { ap_memory {  { ifmap_0_address0 mem_address 1 8 }  { ifmap_0_ce0 mem_ce 1 1 }  { ifmap_0_q0 mem_dout 0 32 }  { ifmap_0_address1 MemPortADDR2 1 8 }  { ifmap_0_ce1 MemPortCE2 1 1 }  { ifmap_0_q1 MemPortDOUT2 0 32 } } }
	ifmap_1 { ap_memory {  { ifmap_1_address0 mem_address 1 8 }  { ifmap_1_ce0 mem_ce 1 1 }  { ifmap_1_q0 mem_dout 0 32 }  { ifmap_1_address1 MemPortADDR2 1 8 }  { ifmap_1_ce1 MemPortCE2 1 1 }  { ifmap_1_q1 MemPortDOUT2 0 32 } } }
	ofmap { ap_memory {  { ofmap_address0 mem_address 1 7 }  { ofmap_ce0 mem_ce 1 1 }  { ofmap_we0 mem_we 1 1 }  { ofmap_d0 mem_din 1 32 } } }
}
