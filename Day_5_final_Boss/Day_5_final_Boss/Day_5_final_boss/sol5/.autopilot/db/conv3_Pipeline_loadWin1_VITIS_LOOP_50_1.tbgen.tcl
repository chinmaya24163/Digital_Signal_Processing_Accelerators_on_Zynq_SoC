set moduleName conv3_Pipeline_loadWin1_VITIS_LOOP_50_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {conv3_Pipeline_loadWin1_VITIS_LOOP_50_1}
...
set C_modelArgList {
	...
	{ select_ln150_2 int 4 regular  }
	{ sub_ln52 int 8 regular  }
	{ select_ln150 int 4 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "window_i_2_2_promoted170", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "select_ln150_2", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
 	{ "Name" : "sub_ln52", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "select_ln150", "interface" : "wire", "bitwidth" : 4, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ select_ln150_2 sc_in sc_lv 4 signal 9 } 
	{ sub_ln52 sc_in sc_lv 8 signal 10 } 
	{ select_ln150 sc_in sc_lv 4 signal 11 } 
	{ mem_4_address0 sc_out sc_lv 10 signal 12 } 
	{ mem_4_ce0 sc_out sc_logic 1 signal 12 } 
	{ mem_4_q0 sc_in sc_lv 32 signal 12 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "select_ln150_2", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "select_ln150_2", "role": "default" }} , 
 	{ "name": "sub_ln52", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sub_ln52", "role": "default" }} , 
 	{ "name": "select_ln150", "direction": "in", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "select_ln150", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	select_ln150_2 { ap_none {  { select_ln150_2 in_data 0 4 } } }
	sub_ln52 { ap_none {  { sub_ln52 in_data 0 8 } } }
	select_ln150 { ap_none {  { select_ln150 in_data 0 4 } } }
	mem_4 { ap_memory {  { mem_4_address0 mem_address 1 10 }  { mem_4_ce0 mem_ce 1 1 }  { mem_4_q0 in_data 0 32 } } }
