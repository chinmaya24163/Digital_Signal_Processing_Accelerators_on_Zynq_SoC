...
if {[file isfile HW_accel.autotvin.dat]} {
	file delete -force HW_accel.autotvin.dat
}

if {[file isfile HW_accel.autotvout.dat]} {
	file delete -force HW_accel.autotvout.dat
}
