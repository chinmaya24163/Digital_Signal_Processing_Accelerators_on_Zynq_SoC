...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.HW_accel.autotvin_inputPort_V_data_V.dat"
         "c.HW_accel.autotvin_inputPort_V_keep_V.dat"
         "c.HW_accel.autotvin_inputPort_V_strb_V.dat"
         "c.HW_accel.autotvin_inputPort_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.HW_accel.autotvout_outputPort_V_data_V.dat"
         "rtl.HW_accel.autotvout_outputPort_V_keep_V.dat"
         "rtl.HW_accel.autotvout_outputPort_V_strb_V.dat"
         "rtl.HW_accel.autotvout_outputPort_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
