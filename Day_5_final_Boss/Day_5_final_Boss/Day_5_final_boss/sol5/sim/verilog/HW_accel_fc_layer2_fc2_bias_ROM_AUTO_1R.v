...
// ==============================================================
`timescale 1 ns / 1 ps
module HW_accel_fc_layer2_fc2_bias_ROM_AUTO_1R (
...
initial begin
    $readmemh("./HW_accel_fc_layer2_fc2_bias_ROM_AUTO_1R.dat", ram0);
    $readmemh("./HW_accel_fc_layer2_fc2_bias_ROM_AUTO_1R.dat", ram1);
    $readmemh("./HW_accel_fc_layer2_fc2_bias_ROM_AUTO_1R.dat", ram2);
end
