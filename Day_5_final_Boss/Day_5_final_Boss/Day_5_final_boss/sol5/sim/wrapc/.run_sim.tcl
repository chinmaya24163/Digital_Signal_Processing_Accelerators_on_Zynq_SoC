...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "HW_accel.autotvin.dat"
	set constFileTvOut       "HW_accel.autotvout.dat"
	set constFileHdlTvIn     "HW_accel.autohdltvin.dat"
	set constFileHdlTvOut    "HW_accel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
